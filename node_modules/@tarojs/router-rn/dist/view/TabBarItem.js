...
export default class TabBarItem extends React.PureComponent {
    ...
    render() {
        const { label, horizontal, showRedDot, badge, size = 20, labelColor, iconSource, userOptions, tabStyle = {}, labelStyle = {}, allowFontScaling = true, showLabel = true } = this.props;
        const tabBarBadgeStyle = (userOptions === null || userOptions === void 0 ? void 0 : userOptions.tabBarBadgeStyle) || {};
