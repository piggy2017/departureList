...
import { View, TouchableWithoutFeedback, Animated, StyleSheet, Platform, Dimensions, Keyboard } from 'react-native';
...
export class TabBar extends React.PureComponent {
    ...
    getTabBarStyle() {
        ...
        const tabStyle = getTabConfig('tabStyle');
        const { color = '', selectedColor = '', backgroundColor = '', borderStyle = '' } = tabStyle;
        const defaultBackground = (style === null || style === void 0 ? void 0 : style.backgroundColor) || 'rgb(255, 255, 255)';
        const defalutBorderTopColor = (style === null || style === void 0 ? void 0 : style.borderTopColor) || 'rgb(216, 216, 216)';
        return {
    ...
    getTabIconSource(index, focused) {
        var _a, _b;
        const item = getDefalutTabItem(index);
        const iconPath = (_a = getTabItemConfig(index, 'iconPath')) !== null && _a !== void 0 ? _a : item === null || item === void 0 ? void 0 : item.iconPath;
        const selectedIconPath = (_b = getTabItemConfig(index, 'selectedIconPath')) !== null && _b !== void 0 ? _b : item === null || item === void 0 ? void 0 : item.selectedIconPath;
    ...
    renderContent() {
        ...
        return React.createElement(View, { style: { flexDirection: 'row', flex: 1 }, onLayout: () => this.handleLayout }, state.routes.map((route, index) => {
            ...
            if (Platform.OS === 'web') {
                ...
                return (React.createElement(Link, { to: linkto, style: [], onPress: (e) => {
                    ...
                    React.createElement(TabBarItem, Object.assign({ showRedDot: showRedDot, badge: badge, label: label, horizontal: horizontal, labelColor: labelColor, iconSource: source, size: 25 }, this.props))));
            }
            else {
                return (React.createElement(TouchableWithoutFeedback, { key: options.tabBarTestID, accessibilityRole: "button", accessibilityState: focused ? { selected: true } : {}, accessibilityLabel: accessibilityLabel, testID: options.tabBarTestID, onPress: onPress, onLongPress: onLongPress },
                    React.createElement(View, { style: [styles.tab, horizontal ? styles.tabLandscape : styles.tabPortrait] },
                        React.createElement(TabBarItem, Object.assign({ label: label, badge: badge, showRedDot: showRedDot, horizontal: true, labelColor: labelColor, iconSource: source, size: 25 }, this.props)))));
            }
        }));
    }
    // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
    render() {
        ...
        const paddingBottom = Math.max((insets === null || insets === void 0 ? void 0 : insets.bottom) - Platform.select({ ios: 4, default: 0 }), 5);
        ...
        if (!needAnimate) {
            ...
            return (React.createElement(Animated.View, { style: [
                ...
                ], pointerEvents: !tabVisible ? 'none' : 'auto' }, this.renderContent()));
        }
    }
}
