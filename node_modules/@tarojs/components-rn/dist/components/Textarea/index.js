...
const _Textarea = (props) => {
    ...
    return (React.createElement(Input, Object.assign({ _multiline: true, _autoHeight: autoHeight, _onLineChange: onLineChange, autoFocus: !!autoFocus, confirmType: "next", onBlur: () => Keyboard.dismiss() }, omit(props, [
        'type',
        'password',
        'confirmType',
        'confirmHold',
