...
export default class Selector extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(AntPicker, { data: range, value: [selected && selected.value], cols: 1, onChange: this.onChange, onPickerChange: this.onPickerChange, onDismiss: this.onDismiss, onVisibleChange: this.onVisibleChange, disabled: disabled },
