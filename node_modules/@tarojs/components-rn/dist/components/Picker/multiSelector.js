...
export default class MultiSelector extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(AntPicker, { data: range, value: value, cols: cols, onChange: this.onChange, onPickerChange: this.onPickerChange, onDismiss: this.onDismiss, disabled: disabled },
