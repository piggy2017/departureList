...
class _Switch extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Switch, { value: this.state.checked, onValueChange: this.onCheckedChange, trackColor: { false: '#FFFFFF', true: color }, ios_backgroundColor: "#FFFFFF", style: style, ref: this.$touchable }));
    }
}
