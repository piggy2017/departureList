...
class _Video extends Component {
    constructor({ props, context }) {
        ...
        this.onLoadedMetaData = (event) => {
            ...
            // @ts-ignore
            this.props.onLoadedMetaData && this.props.onLoadedMetaData({ detail: Object.assign(Object.assign({}, naturalSize), status) });
        };
        this.onFullscreenChange = (event) => {
            const { fullscreenUpdate, status } = event;
            const fullScreen = fullscreenUpdate === Video.FULLSCREEN_UPDATE_PLAYER_WILL_PRESENT || fullscreenUpdate === Video.FULLSCREEN_UPDATE_PLAYER_DID_PRESENT;
            const detail = Object.assign({ fullScreen: fullscreenUpdate === Video.FULLSCREEN_UPDATE_PLAYER_WILL_PRESENT || fullscreenUpdate === Video.FULLSCREEN_UPDATE_PLAYER_DID_PRESENT, fullscreenUpdate, direction: 1 }, status);
    ...
    render() {
        const { src, autoplay, style, initialTime, loop, muted, objectFit = 'contain', poster, controls, showCenterPlayBtn, } = this.props;
        ...
        const videoNode = (React.createElement(View, { style: [
            ...
            showPlayBtn && !this.state.isPlaying && (React.createElement(View, { style: Styles['taro-video-cover'] },
                React.createElement(Image, { src: require('../../assets/video/play.png'), style: Styles['taro-video-cover-play-button'], onClick: this.clickPlayBtn }),
                React.createElement(Text, { style: Styles['taro-video-cover-duration'] }, duration))),
            this.props.children));
