...
import { TouchableWithoutFeedback, Text, View, Image, Animated, Easing } from 'react-native';
...
class _Button extends React.Component {
    ...
    render() {
        const { style, children, size, type, plain, disabled, loading, hoverStyle, } = this.props;
        ...
        return (React.createElement(TouchableWithoutFeedback, { onPress: this.onPress, onLongPress: this.onPress, onPressIn: this.onPressIn, onPressOut: this.onPressOut, ref: this.$touchable, disabled: disabled },
            React.createElement(View, { style: [
                ...
                loading && (React.createElement(Animated.View, { style: [styles.loading, { transform: [{ rotate: rotateDeg }] }] },
                    React.createElement(Image, { source: type === 'warn' ? require('../../assets/loading-warn.png') : require('../../assets/loading.png'), style: styles.loadingImg }))),
                Array.isArray(children) ? (children.map((c, i) => (React.createElement(Text, { key: i, style: [styles.btnText, !isDefaultSize && styles.btnTextMini, { color: textColor }] }, c)))) : (['string', 'number'].indexOf(typeof children) > -1) ? (React.createElement(Text, { style: [styles.btnText, !isDefaultSize && styles.btnTextMini, { color: textColor }] }, children)) : (children))));
    }
}
