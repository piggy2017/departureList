...
function createRouter(app, config, framework) {
    ...
    var render = async function (location, action) {
        ...
        if (shouldLoad) {
            ...
            var page = runtime.createPageConfig(enablePullDownRefresh ? (_d = runtime.CurrentReconciler.createPullDownComponent) === null || _d === void 0 ? void 0 : _d.call(runtime.CurrentReconciler, el, location.pathname, framework, routerConfig.PullDownRefresh) : el, location.pathname + runtime.stringify(qs()), {}, config$1);
