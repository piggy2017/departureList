...
function createRouter(app, config, framework) {
    ...
    const render = async (location, action) => {
        ...
        if (shouldLoad) {
            ...
            delete config['path'];
            delete config['load'];
            const page = createPageConfig(enablePullDownRefresh ? (_d = CurrentReconciler.createPullDownComponent) === null || _d === void 0 ? void 0 : _d.call(CurrentReconciler, el, location.pathname, framework, routerConfig.PullDownRefresh) : el, location.pathname + stringify(qs()), {}, config);
