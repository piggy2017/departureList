...
export function chooseVideo(opts) {
    ...
    switch (JSON.stringify(sourceType)) {
        case '[\'camera\']':
        case '["camera"]':
            return chooseMedia(Object.assign(Object.assign({}, opts), { sourceType: ['camera'] }), MEDIA_TYPE.VIDEOS);
        case '[\'album\']':
        case '["album"]':
            return chooseMedia(Object.assign(Object.assign({}, opts), { sourceType: ['album'] }), MEDIA_TYPE.VIDEOS);
        default:
 ...
 * @returns {Promise}
 */
function showVideoPicker(options) {
    ...
    return new Promise((resolve, reject) => {
        showActionSheet({
            ...
            success: function (res) {
                if (res.tapIndex === 0) {
                    resolve(chooseMedia(Object.assign(Object.assign({}, options), { sourceType: ['camera'] }), MEDIA_TYPE.VIDEOS));
                }
                if (res.tapIndex === 1) {
                    resolve(chooseMedia(Object.assign(Object.assign({}, options), { sourceType: ['album'] }), MEDIA_TYPE.VIDEOS));
                }
            },
            fail: function (err) {
