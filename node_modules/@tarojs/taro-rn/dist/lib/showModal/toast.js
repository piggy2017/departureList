...
const WXLoading = ({ title, mask }) => {
    return (React.createElement(View, { style: mask ? styles.container : styles.noMaskContainer },
        React.createElement(View, { style: styles.grayBlock },
            React.createElement(ActivityIndicator, { animating: true, style: { flex: 1 }, size: 'small', color: '#eee' }),
...
function showToast(options) {
    ...
    let ToastView;
    if (image) {
        ToastView = React.createElement(View, { style: maskStyle },
            React.createElement(View, { style: styles.grayBlock },
        ...
        ToastView = React.createElement(WXLoading, { title: title, mask: mask });
    }
    else if (icon === 'none') {
        ToastView = React.createElement(View, { style: maskStyle },
