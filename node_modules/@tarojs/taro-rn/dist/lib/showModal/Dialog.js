...
import { View, Text, TouchableHighlight, Dimensions, StyleSheet, Platform, ViewPropTypes } from 'react-native';
...
// 类型定义
const Index = ({ visible = false, buttons = [], title, style, maskStyle, headerStyle, titleStyle, bodyStyle, bodyTextStyle, footerStyle, children, onClose, autoDectect = true, type = 'ios' }) => {
    let _type = type;
    if (autoDectect)
        _type = Platform.OS;
    ...
    return (React.createElement(View, { style: [styles.Modal, visible ? styles.visible : styles.hidden] },
        React.createElement(Mask, { style: [styles.dialogWrapper, maskStyle], onPress: onClose },
            React.createElement(View, { style: [styles.dialog, style] },
                React.createElement(View, { style: [styles.dialogHeader, headerStyle] },
                    React.createElement(Text, { style: [styles.dialogTitle, styles[`${_type}DialogTitle`], titleStyle] }, title)),
                React.createElement(View, { style: [styles.dialogBody, styles[`${_type}DialogBody`], bodyStyle] }, childrenWithProps),
                React.createElement(View, { style: [styles.dialogFooter, styles[`${_type}DialogFooter`], footerStyle] }, _renderButtons())))));
};
Index.propTypes = {
