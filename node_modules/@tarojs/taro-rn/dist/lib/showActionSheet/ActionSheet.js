...
import { View, Text, TouchableHighlight, StyleSheet, Platform, ViewPropTypes } from 'react-native';
...
const Index = ({ visible, style, maskStyle, onShow, onClose, menus = [], actions = [], autoDectect = true, type = 'ios' }) => {
    ...
    return _type === 'ios'
        ? React.createElement(Popup, { visible: visible, style: [styles.iosActionsheet, style], maskStyle: maskStyle, onShow: onShow, onClose: onClose },
            menus.length
